...
class FormationWindow(wx.Panel):
    def __init__(self,parent,gdb):
        ...
        # formation list
        self.form_listbox = wx.ListBox(left_panel,-1, choices=self.gdb.gm_forms_db.names,
    ...
    def load_formation(self,event):
        ...
        new_formation = self.gdb.gm_forms_db.formation_by_name(selected)
    ...
    def add_equip_item(self,equip="",qty=""):
        equips = self.gdb.equip_db.names
